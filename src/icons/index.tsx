...
export const HomeIcon = (style: StyleType): IconElement => (
  <Icon {...style} name='home' />
);

export const PersonIcon = (style: StyleType): IconElement => (
  <Icon {...style} name='person' />
);

export const SignOutIcon = (style: StyleType): IconElement => (
