...
import { SafeAreaLayout, SafeAreaLayoutElement, SaveAreaInset } from 'src/components/safeAreaLayout/SafeAreaLayout';
import { SignOutIcon } from 'src/icons';

export const AuthTabBar = (props): SafeAreaLayoutElement => {
